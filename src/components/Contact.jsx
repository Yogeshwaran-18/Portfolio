...
const Contact = () => {
  return (
    ...
    gap-16 p-8'>
      ...
      <form className='flex w-full max-w flex-col
      gap-8 rounded-lg p-6 md:max-w-lg lg:max-w-xl'>
        
        <div className='flex flex-col gap-4'>
          <input type="text" placeholder='Your Name' 
          className='rounded-lg border-2 border-teal-400
          px-4 py-3 text-lg outline-none transition-all duration-200
          hover:ng-teal-50 focus:ring-2 focus:ring-2
          focus:ring-teal-500'/>
        ...
        rounded-lg border-2 border-teal-400
        px-4 py-3 text-lg outline-none transition-all duration-200
