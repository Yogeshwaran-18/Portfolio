    ...
    w-full items-center justify-center'>
      ...
      justify-center gap-8 p-5 text-center">
        ...
        <div className="space-y-1 sm:space-y-3">
          ...
          text-4x1 font-semibold text-transparent
          md:text-5x1 lg:text-6xl'>YOGESHWARAN T A</h1>
          <h3 className='bg-gradient-to-r
          from-teal-400 to-teal-600 bg-clip-text
          text-x1 font-semibold text-transparent
          md:text-2x1 lg:text-3xl'>Web Developer</h3>
          <p className='max-w-[500px] text-sm
          text-gray-500'>A web developer is a professional who builds 
          and maintains websites or web applications. 
          They are responsible for the functionality, 
          performance, and sometimes the design of a website. </p>
        </div>
        <div className="flex gap-3">
        <a href="https://github.com/Yogeshwaran-18" target="_blank" rel="noopener noreferrer">
          <BiLogoGithub className='h-10 w-10
          ...
          <BiLogoTwitter className='h-10 w-10
          cursor-pointer rounded-full border-2
          border-transparent bg-teal-600 p-2
          text-white transition-all duration-200
          hover:scale-110 hover:border-teal-600
